...
import registerlogo from '../../Assets/old.jpg'
...
onSubmit:handleSubmit
  ...
  <div className="d-flex justify-content-center align-items-center ">
      <div className="row w-75 regLeft  regrow rounded-end-4  ">
        
          <div className="col-md-5 p-2 regLeft  ">
            <div className="  ">
            <h3 className=' fw-bold text-white text-center'>A Note App For Your Dementia & ADHD</h3>

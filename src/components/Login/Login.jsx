...
import login from '../../Assets/old2.jpg'
  ...
  <div className="d-flex justify-content-center align-items-center ">
      <div className="row   w-100 regLeft  rounded-end-4  ">
          ...
          <div className="col-md-5 p-3 regLeft  ">
            <div className="  ">
            <h4 className=' fw-bold text-white text-center'>A Note App For Your Dementia & ADHD</h4>
            <img src={login} className='w-100 registerlogo bg-white' alt="" />
              <div className="d-flex gap-2 justify-content-center align-items-center">
                <p className='mt-3 logp text-white'>you don't have an account?</p>
                <Link to='/register'>
